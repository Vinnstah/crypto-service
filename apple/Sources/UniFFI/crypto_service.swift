...
public struct CoinHistory {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(name: String?, symbol: String?, rank: Int64?, color: String?, png64: String?, webp64: String?, history: History?, allTimeHighUsd: Double?, code: String?, rate: Double?, delta: Delta?) {
        self.name = name
        self.symbol = symbol
        self.rank = rank
        self.color = color
...
public struct FfiConverterTypeCoinHistory: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> CoinHistory {
        return
            try CoinHistory(
                ...
                history: FfiConverterOptionTypeHistory.read(from: &buf),
    ...
    public static func write(_ value: CoinHistory, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionTypeHistory.write(value.history, into: &buf)
...
private struct FfiConverterOptionTypeHistory: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeHistory.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeHistory.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
