    ...
    GatewayProtocol
{
    ...
    open func getListOfAggCoins(address: String) async throws -> [AggregatedCoinInformation] {
        return
...
public protocol NetworkAntennaProtocol: AnyObject {
    func makeRequest(request: FfiNetworkingRequest) async throws -> FfiNetworkingResponse
}

open class NetworkAntenna:
    NetworkAntennaProtocol
{
    fileprivate let pointer: UnsafeMutableRawPointer!
...
public struct FfiConverterTypeNetworkAntenna: FfiConverter {
    ...
    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> NetworkAntenna {
        return NetworkAntenna(unsafeFromRawPointer: pointer)
    }
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_crypto_service_checksum_method_gateway_get_list_of_agg_coins() != 41419 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_crypto_service_checksum_method_networkantenna_make_request() != 5199 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_crypto_service_checksum_constructor_gateway_new() != 31832 {
        return InitializationResult.apiChecksumMismatch
    }
