...
public protocol GatewayProtocol: AnyObject {
    ...
    func getListOfCoins(limit: UInt32) async throws -> [Coin]
}
    ...
    GatewayProtocol
{
    ...
    open func getListOfCoins(limit: UInt32) async throws -> [Coin] {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_crypto_service_checksum_method_gateway_get_list_of_coins() != 18960 {
        return InitializationResult.apiChecksumMismatch
    }
