...
public struct OrderBookResponse {
...
extension OrderBookResponse: Equatable, Hashable {
    public static func == (lhs: OrderBookResponse, rhs: OrderBookResponse) -> Bool {
...
public struct FfiConverterTypeOrderBookResponse: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> OrderBookResponse {
        return
            try OrderBookResponse(
    ...
    public static func write(_ value: OrderBookResponse, into buf: inout [UInt8]) {
...
public func FfiConverterTypeOrderBookResponse_lift(_ buf: RustBuffer) throws -> OrderBookResponse {
    return try FfiConverterTypeOrderBookResponse.lift(buf)
}

public func FfiConverterTypeOrderBookResponse_lower(_ value: OrderBookResponse) -> RustBuffer {
    return FfiConverterTypeOrderBookResponse.lower(value)
}
