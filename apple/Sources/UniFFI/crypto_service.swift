...
public protocol GatewayProtocol: AnyObject {
    func getCoinHistoryInfo(request: CoinHistoryRequest) async throws -> CoinMeta
    ...
    GatewayProtocol
{
    ...
    open func getCoinHistoryInfo(request: CoinHistoryRequest) async throws -> CoinMeta {
        return
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_crypto_service_checksum_method_gateway_get_coin_history_info() != 13342 {
