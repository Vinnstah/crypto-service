...
public protocol FfiNetworkingExecutor: AnyObject {
    func executeNetworkingRequest(request: FfiNetworkRequest, listenerRustSide: FfiNetworkingOutcomeListener) throws
}
    ...
    FfiNetworkingExecutor
{
    ...
    public func executeNetworkingRequest(request: FfiNetworkRequest, listenerRustSide: FfiNetworkingOutcomeListener) throws {
        try
            rustCallWithError(FfiConverterTypeUniffiError.lift) {
                uniffi_crypto_service_fn_method_ffinetworkingexecutor_execute_networking_request(self.uniffiClonePointer(),
                                                                                                 FfiConverterTypeFFINetworkRequest.lower(request),
    ...
    func invokeExecuteNetworkingRequest(_ swiftCallbackInterface: FfiNetworkingExecutor, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _ out_buf: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
        ...
        func makeCall() throws -> Int32 {
            try swiftCallbackInterface.executeNetworkingRequest(
                request: FfiConverterTypeFFINetworkRequest.read(from: &reader),
        ...
        do {
            return try makeCall()
        } catch let error as UniffiError {
            out_buf.pointee = FfiConverterTypeUniffiError.lower(error)
...
public struct FfiNetworkRequest {
...
extension FfiNetworkRequest: Equatable, Hashable {
    public static func == (lhs: FfiNetworkRequest, rhs: FfiNetworkRequest) -> Bool {
        if lhs.url != rhs.url {
            return false
        }
...
public struct FfiConverterTypeFFINetworkRequest: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FfiNetworkRequest {
        return
            try FfiNetworkRequest(
    ...
    public static func write(_ value: FfiNetworkRequest, into buf: inout [UInt8]) {
...
public func FfiConverterTypeFFINetworkRequest_lift(_ buf: RustBuffer) throws -> FfiNetworkRequest {
    return try FfiConverterTypeFFINetworkRequest.lift(buf)
}

public func FfiConverterTypeFFINetworkRequest_lower(_ value: FfiNetworkRequest) -> RustBuffer {
    return FfiConverterTypeFFINetworkRequest.lower(value)
}
...
public struct FfiConverterTypeFFINetworkingOutcome: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FfiNetworkingOutcome {
        ...
        case 2: return try .failure(
                error: FfiConverterTypeUniffiError.read(from: &buf)
            )
    ...
    public static func write(_ value: FfiNetworkingOutcome, into buf: inout [UInt8]) {
        ...
        case let .failure(error):
            ...
            FfiConverterTypeUniffiError.write(error, into: &buf)
        }
    }
}
...
public enum UniffiError {
    case FailedToNotifyOutcome(
        string: String
    )
    case FailedToExecuteRequest(
        string: String
    )

    fileprivate static func uniffiErrorHandler(_ error: RustBuffer) throws -> Error {
        return try FfiConverterTypeUniffiError.lift(error)
    }
}
...
public struct FfiConverterTypeUniffiError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> UniffiError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .FailedToNotifyOutcome(
                string: FfiConverterString.read(from: &buf)
            )
        case 2: return try .FailedToExecuteRequest(
                string: FfiConverterString.read(from: &buf)
            )
    ...
    public static func write(_ value: UniffiError, into buf: inout [UInt8]) {
        switch value {
        case let .FailedToNotifyOutcome(string):
            writeInt(&buf, Int32(1))
            FfiConverterString.write(string, into: &buf)

        case let .FailedToExecuteRequest(string):
            writeInt(&buf, Int32(2))
            FfiConverterString.write(string, into: &buf)
        }
    }
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_crypto_service_checksum_method_ffinetworkingexecutor_execute_networking_request() != 35034 {
