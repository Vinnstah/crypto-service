...
public protocol GatewayProtocol: AnyObject {
    func getListOfCoins(key: String, limit: UInt32) async throws -> [Coin]
}
    ...
    GatewayProtocol
{
    ...
    open func getListOfCoins(key: String, limit: UInt32) async throws -> [Coin] {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_crypto_service_fn_method_gateway_get_list_of_coins(
                        self.uniffiClonePointer(),
                        FfiConverterString.lower(key), FfiConverterUInt32.lower(limit)
                    )
                },
...
public protocol NetworkAntenna: AnyObject {
    ...
    func getBinanceKey() -> ClientKeys

    func getCoinwatchKey() -> ClientKeys

    func getAlphaKey() -> ClientKeys
}
    ...
    NetworkAntenna
{
    ...
    open func getBinanceKey() -> ClientKeys {
        return try! FfiConverterTypeClientKeys.lift(try! rustCall {
            uniffi_crypto_service_fn_method_networkantenna_get_binance_key(self.uniffiClonePointer(), $0)
        })
    }

    open func getCoinwatchKey() -> ClientKeys {
        return try! FfiConverterTypeClientKeys.lift(try! rustCall {
            uniffi_crypto_service_fn_method_networkantenna_get_coinwatch_key(self.uniffiClonePointer(), $0)
        })
    }

    open func getAlphaKey() -> ClientKeys {
        return try! FfiConverterTypeClientKeys.lift(try! rustCall {
            uniffi_crypto_service_fn_method_networkantenna_get_alpha_key(self.uniffiClonePointer(), $0)
        })
    }
}
    ...
    static var vtable: UniffiVTableCallbackInterfaceNetworkAntenna = .init(
        ...
        getBinanceKey: { (
            ...
            let makeCall = {
                ...
                return uniffiObj.getBinanceKey(
                )
            }
        ...
        getCoinwatchKey: { (
            ...
            let makeCall = {
                ...
                return uniffiObj.getCoinwatchKey(
                )
            }
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_crypto_service_checksum_method_gateway_get_list_of_coins() != 5692 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_crypto_service_checksum_method_networkantenna_make_request() != 5199 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_crypto_service_checksum_method_networkantenna_get_binance_key() != 16570 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_crypto_service_checksum_method_networkantenna_get_coinwatch_key() != 54391 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_crypto_service_checksum_method_networkantenna_get_alpha_key() != 49617 {
        return InitializationResult.apiChecksumMismatch
    }
