...
public protocol FfiNetworkingExecutor: AnyObject {
    func executeNetworkingRequest(request: FfiNetworkingRequest, listenerRustSide: FfiNetworkingOutcomeListener) throws
}

public class FfiNetworkingExecutorImpl:
    FfiNetworkingExecutor
{
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_crypto_service_fn_clone_ffinetworkingexecutor(self.pointer, $0) }
    }

    deinit {
        try! rustCall { uniffi_crypto_service_fn_free_ffinetworkingexecutor(pointer, $0) }
    }

    public func executeNetworkingRequest(request: FfiNetworkingRequest, listenerRustSide: FfiNetworkingOutcomeListener) throws {
        try
            rustCallWithError(FfiConverterTypeFFINetworkingError.lift) {
                uniffi_crypto_service_fn_method_ffinetworkingexecutor_execute_networking_request(self.uniffiClonePointer(),
                                                                                                 FfiConverterTypeFFINetworkingRequest.lower(request),
                                                                                                 FfiConverterTypeFFINetworkingOutcomeListener.lower(listenerRustSide), $0)
            }
    }
}
...
// Declaration and FfiConverters for FfiNetworkingExecutor Callback Interface

private let uniffiCallbackInterfaceFFINetworkingExecutor: ForeignCallback = { (handle: UniFFICallbackHandle, method: Int32, argsData: UnsafePointer<UInt8>, argsLen: Int32, out_buf: UnsafeMutablePointer<RustBuffer>) -> Int32 in

    func invokeExecuteNetworkingRequest(_ swiftCallbackInterface: FfiNetworkingExecutor, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _ out_buf: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
        var reader = createReader(data: Data(bytes: argsData, count: Int(argsLen)))
        func makeCall() throws -> Int32 {
            try swiftCallbackInterface.executeNetworkingRequest(
                request: FfiConverterTypeFFINetworkingRequest.read(from: &reader),
                listenerRustSide: FfiConverterTypeFFINetworkingOutcomeListener.read(from: &reader)
            )
            return UNIFFI_CALLBACK_SUCCESS
        }
        do {
            return try makeCall()
        } catch let error as FfiNetworkingError {
            out_buf.pointee = FfiConverterTypeFFINetworkingError.lower(error)
    ...
    case IDX_CALLBACK_FREE:
        FfiConverterTypeFFINetworkingExecutor.handleMap.remove(handle: handle)
        // Successful return
        // See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs`
        return UNIFFI_CALLBACK_SUCCESS
    case 1:
        guard let cb = FfiConverterTypeFFINetworkingExecutor.handleMap.get(handle: handle) else {
            out_buf.pointee = FfiConverterString.lower("No callback in handlemap; this is a Uniffi bug")
            return UNIFFI_CALLBACK_UNEXPECTED_ERROR
        }
        do {
            return try invokeExecuteNetworkingRequest(cb, argsData, argsLen, out_buf)
        } catch {
...
private func uniffiCallbackInitFFINetworkingExecutor() {
    uniffi_crypto_service_fn_init_callback_ffinetworkingexecutor(uniffiCallbackInterfaceFFINetworkingExecutor)
}

public struct FfiConverterTypeFFINetworkingExecutor: FfiConverter {
    fileprivate static var handleMap = UniFFICallbackHandleMap<FfiNetworkingExecutor>()

    typealias FfiType = UnsafeMutableRawPointer
    typealias SwiftType = FfiNetworkingExecutor

    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiNetworkingExecutor {
        return FfiNetworkingExecutorImpl(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: FfiNetworkingExecutor) -> UnsafeMutableRawPointer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FfiNetworkingExecutor {
    ...
    public static func write(_ value: FfiNetworkingExecutor, into buf: inout [UInt8]) {
...
public func FfiConverterTypeFFINetworkingExecutor_lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiNetworkingExecutor {
    return try FfiConverterTypeFFINetworkingExecutor.lift(pointer)
}

public func FfiConverterTypeFFINetworkingExecutor_lower(_ value: FfiNetworkingExecutor) -> UnsafeMutableRawPointer {
    return FfiConverterTypeFFINetworkingExecutor.lower(value)
}

public protocol FfiNetworkingOutcomeListenerProtocol: AnyObject {
    func notifyOutcome(result: FfiNetworkingOutcome)
}

public class FfiNetworkingOutcomeListener:
    FfiNetworkingOutcomeListenerProtocol
{
    fileprivate let pointer: UnsafeMutableRawPointer
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_crypto_service_fn_clone_ffinetworkingoutcomelistener(self.pointer, $0) }
    }

    deinit {
        try! rustCall { uniffi_crypto_service_fn_free_ffinetworkingoutcomelistener(pointer, $0) }
    }

    public func notifyOutcome(result: FfiNetworkingOutcome) {
        try!
            rustCall {
                uniffi_crypto_service_fn_method_ffinetworkingoutcomelistener_notify_outcome(self.uniffiClonePointer(),
                                                                                            FfiConverterTypeFFINetworkingOutcome.lower(result), $0)
            }
    }
}

public struct FfiConverterTypeFFINetworkingOutcomeListener: FfiConverter {
    typealias FfiType = UnsafeMutableRawPointer
    typealias SwiftType = FfiNetworkingOutcomeListener

    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiNetworkingOutcomeListener {
        return FfiNetworkingOutcomeListener(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: FfiNetworkingOutcomeListener) -> UnsafeMutableRawPointer {
        return value.uniffiClonePointer()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FfiNetworkingOutcomeListener {
        let v: UInt64 = try readInt(&buf)
        // The Rust code won't compile if a pointer won't fit in a UInt64.
        // We have to go via `UInt` because that's the thing that's the size of a pointer.
        let ptr = UnsafeMutableRawPointer(bitPattern: UInt(truncatingIfNeeded: v))
    ...
    public static func write(_ value: FfiNetworkingOutcomeListener, into buf: inout [UInt8]) {
        // This fiddling is because `Int` is the thing that's the same size as a pointer.
        // The Rust code won't compile if a pointer won't fit in a `UInt64`.
        writeInt(&buf, UInt64(bitPattern: Int64(Int(bitPattern: lower(value)))))
    }
...
public func FfiConverterTypeFFINetworkingOutcomeListener_lift(_ pointer: UnsafeMutableRawPointer) throws -> FfiNetworkingOutcomeListener {
    return try FfiConverterTypeFFINetworkingOutcomeListener.lift(pointer)
}

public func FfiConverterTypeFFINetworkingOutcomeListener_lower(_ value: FfiNetworkingOutcomeListener) -> UnsafeMutableRawPointer {
    return FfiConverterTypeFFINetworkingOutcomeListener.lower(value)
}

public protocol GatewayProtocol: AnyObject {
    func getListOfAggCoins(address: String) async throws -> [AggregatedCoinInformation]
}
    ...
    GatewayProtocol
{
     ...
     */
    public convenience init(networkAntenna: FfiNetworkingExecutor) {
        self.init(unsafeFromRawPointer: try! rustCall {
            uniffi_crypto_service_fn_constructor_gateway_new(
                FfiConverterTypeFFINetworkingExecutor.lower(networkAntenna), $0
            )
        })
    }
    ...
    public func getListOfAggCoins(address: String) async throws -> [AggregatedCoinInformation] {
        return try await uniffiRustCallAsync(
            ...
            liftFunc: FfiConverterSequenceTypeAggregatedCoinInformation.lift,
...
public struct TopAndBottomTrades {
    ...
    public init(
        metadata: String,
        lastUpdated: String,
        topGainers: [MostActivelyTraded],
        topLosers: [MostActivelyTraded],
        mostActivelyTraded: [MostActivelyTraded]
    ) {
...
public enum FfiBridgeError {
    ...
    fileprivate static func uniffiErrorHandler(_ error: RustBuffer) throws -> Error {
        return try FfiConverterTypeFFIBridgeError.lift(error)
    }
}
...
public enum FfiNetworkingError {
    ...
    case RequestFailed(
        statusCode: UInt16?,
        urlSessionUnderlyingError: String?,
        errorMessageFromGateway: String?
    )

    fileprivate static func uniffiErrorHandler(_ error: RustBuffer) throws -> Error {
        return try FfiConverterTypeFFINetworkingError.lift(error)
    }
}
...
public enum FfiNetworkingOutcome {
    case success(
...
public struct FfiConverterTypeFFINetworkingOutcome: FfiConverterRustBuffer {
    typealias SwiftType = FfiNetworkingOutcome

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FfiNetworkingOutcome {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .success(
                value: FfiConverterTypeFFINetworkingResponse.read(from: &buf)
            )

        case 2: return try .failure(
                error: FfiConverterTypeFFINetworkingError.read(from: &buf)
            )
    ...
    public static func write(_ value: FfiNetworkingOutcome, into buf: inout [UInt8]) {
        switch value {
        case let .success(value):
            writeInt(&buf, Int32(1))
            FfiConverterTypeFFINetworkingResponse.write(value, into: &buf)
...
public func FfiConverterTypeFFINetworkingOutcome_lift(_ buf: RustBuffer) throws -> FfiNetworkingOutcome {
    return try FfiConverterTypeFFINetworkingOutcome.lift(buf)
}

public func FfiConverterTypeFFINetworkingOutcome_lower(_ value: FfiNetworkingOutcome) -> RustBuffer {
    return FfiConverterTypeFFINetworkingOutcome.lower(value)
}

extension FfiNetworkingOutcome: Equatable, Hashable {}
...
public enum RustSideError {
    ...
    case unableJsonDeserializeHttpResponseBodyIntoTypeName(
        typeName: String
    )
...
public struct FfiConverterTypeRustSideError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RustSideError {
        ...
        case 3: return try .unableJsonDeserializeHttpResponseBodyIntoTypeName(
...
private struct FfiConverterSequenceTypeAggregatedCoinInformation: FfiConverterRustBuffer {
    typealias SwiftType = [AggregatedCoinInformation]

    public static func write(_ value: [AggregatedCoinInformation], into buf: inout [UInt8]) {
        let len = Int32(value.count)
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeAggregatedCoinInformation.write(item, into: &buf)
        }
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [AggregatedCoinInformation] {
        let len: Int32 = try readInt(&buf)
        var seq = [AggregatedCoinInformation]()
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            try seq.append(FfiConverterTypeAggregatedCoinInformation.read(from: &buf))
        }
        return seq
    }
}
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_crypto_service_checksum_method_ffinetworkingexecutor_execute_networking_request() != 65498 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_crypto_service_checksum_method_ffinetworkingoutcomelistener_notify_outcome() != 15839 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_crypto_service_checksum_method_gateway_get_list_of_agg_coins() != 36893 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_crypto_service_checksum_constructor_gateway_new() != 52556 {
        return InitializationResult.apiChecksumMismatch
    }

    uniffiCallbackInitFFINetworkingExecutor()
