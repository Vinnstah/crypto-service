    ...
    DataTaskProtocol
{
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_crypto_service_fn_clone_datatask(self.pointer, $0) }
    }

    deinit {
        try! rustCall { uniffi_crypto_service_fn_free_datatask(pointer, $0) }
    }
    ...
    public func install() -> Bool {
        return try! FfiConverterBool.lift(
            try!
                rustCall {
                    uniffi_crypto_service_fn_method_datatask_install(self.uniffiClonePointer(), $0)
                }
        )
    }
}

public struct FfiConverterTypeDataTask: FfiConverter {
    typealias FfiType = UnsafeMutableRawPointer
    typealias SwiftType = DataTask

    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> DataTask {
        return DataTask(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: DataTask) -> UnsafeMutableRawPointer {
        return value.uniffiClonePointer()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> DataTask {
    ...
    public static func write(_ value: DataTask, into buf: inout [UInt8]) {
...
public func FfiConverterTypeDataTask_lift(_ pointer: UnsafeMutableRawPointer) throws -> DataTask {
    return try FfiConverterTypeDataTask.lift(pointer)
}

public func FfiConverterTypeDataTask_lower(_ value: DataTask) -> UnsafeMutableRawPointer {
    return FfiConverterTypeDataTask.lower(value)
}

public struct ApiClient {
    public let client: DataTask
...
public struct FfiConverterTypeApiClient: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ApiClient {
        return
            try ApiClient(
                client: FfiConverterTypeDataTask.read(from: &buf)
            )
    }

    public static func write(_ value: ApiClient, into buf: inout [UInt8]) {
        FfiConverterTypeDataTask.write(value.client, into: &buf)
    }
}

public func FfiConverterTypeApiClient_lift(_ buf: RustBuffer) throws -> ApiClient {
    return try FfiConverterTypeApiClient.lift(buf)
}

public func FfiConverterTypeApiClient_lower(_ value: ApiClient) -> RustBuffer {
...
public struct FfiConverterTypeOrder: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Order {
        return
            try Order(
                price: FfiConverterSequenceString.read(from: &buf),
                amount: FfiConverterSequenceString.read(from: &buf)
            )
    }

    public static func write(_ value: Order, into buf: inout [UInt8]) {
        FfiConverterSequenceString.write(value.price, into: &buf)
        FfiConverterSequenceString.write(value.amount, into: &buf)
    }
}
...
public struct FfiConverterTypeOrderBook: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> OrderBook {
        return
            try OrderBook(
                asks: FfiConverterSequenceTypeOrder.read(from: &buf),
                bids: FfiConverterSequenceTypeOrder.read(from: &buf),
                lastUpdateId: FfiConverterUInt64.read(from: &buf)
            )
    }

    public static func write(_ value: OrderBook, into buf: inout [UInt8]) {
        FfiConverterSequenceTypeOrder.write(value.asks, into: &buf)
        FfiConverterSequenceTypeOrder.write(value.bids, into: &buf)
...
private struct FfiConverterSequenceTypeOrder: FfiConverterRustBuffer {
    ...
    public static func write(_ value: [Order], into buf: inout [UInt8]) {
        ...
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeOrder.write(item, into: &buf)
        }
    }
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [Order] {
        ...
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            try seq.append(FfiConverterTypeOrder.read(from: &buf))
        }
        return seq
    }
}
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_crypto_service_checksum_method_datatask_install() != 26879 {
