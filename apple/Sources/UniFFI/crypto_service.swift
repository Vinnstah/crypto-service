...
public protocol GatewayProtocol: AnyObject {
    func getCoinMetaInfo(code: String) async throws -> CoinMeta
    ...
    GatewayProtocol
{
    ...
    open func getCoinMetaInfo(code: String) async throws -> CoinMeta {
        return
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_crypto_service_checksum_method_gateway_get_coin_meta_info() != 48147 {
