...
public protocol GatewayProtocol: AnyObject {
    func getCoinHistoryInfo(request: CoinHistoryRequest) async throws -> CoinHistory

    func getCoinMetaInfo(request: CoinMetaRequest) async throws -> CoinMeta

    func getListOfCoins(limit: UInt32) async throws -> [CoinMeta]
}
    ...
    GatewayProtocol
{
    ...
    open func getCoinHistoryInfo(request: CoinHistoryRequest) async throws -> CoinHistory {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_crypto_service_fn_method_gateway_get_coin_history_info(
                        self.uniffiClonePointer(),
                        FfiConverterTypeCoinHistoryRequest.lower(request)
                    )
                },
                ...
                liftFunc: FfiConverterTypeCoinHistory.lift,
                errorHandler: FfiConverterTypeFFIBridgeError.lift
            )
    }

    open func getCoinMetaInfo(request: CoinMetaRequest) async throws -> CoinMeta {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_crypto_service_fn_method_gateway_get_coin_meta_info(
                        self.uniffiClonePointer(),
                        FfiConverterTypeCoinMetaRequest.lower(request)
                    )
                },
                pollFunc: ffi_crypto_service_rust_future_poll_rust_buffer,
                completeFunc: ffi_crypto_service_rust_future_complete_rust_buffer,
                freeFunc: ffi_crypto_service_rust_future_free_rust_buffer,
                liftFunc: FfiConverterTypeCoinMeta.lift,
                errorHandler: FfiConverterTypeFFIBridgeError.lift
            )
    }

    open func getListOfCoins(limit: UInt32) async throws -> [CoinMeta] {
        return
            try await uniffiRustCallAsync(
                rustFutureFunc: {
                    uniffi_crypto_service_fn_method_gateway_get_list_of_coins(
                        self.uniffiClonePointer(),
                ...
                completeFunc: ffi_crypto_service_rust_future_complete_rust_buffer,
                freeFunc: ffi_crypto_service_rust_future_free_rust_buffer,
                liftFunc: FfiConverterSequenceTypeCoinMeta.lift,
                errorHandler: FfiConverterTypeFFIBridgeError.lift
            )
    }
}
    ...
    NetworkAntenna
{
    ...
    open func getApiKeys() -> ClientKeys {
        return try! FfiConverterTypeClientKeys.lift(try! rustCall {
            uniffi_crypto_service_fn_method_networkantenna_get_api_keys(self.uniffiClonePointer(), $0)
        })
    }
}
...
private enum UniffiCallbackInterfaceNetworkAntenna {
    ...
    static var vtable: UniffiVTableCallbackInterfaceNetworkAntenna = .init(
        ...
        getApiKeys: { (
            ...
            let makeCall = {
                () throws -> ClientKeys in
                guard let uniffiObj = try? FfiConverterTypeNetworkAntenna.handleMap.get(handle: uniffiHandle) else {
                    throw UniffiInternalError.unexpectedStaleHandle
                }
                return uniffiObj.getApiKeys(
                )
            }

            let writeReturn = { uniffiOutReturn.pointee = FfiConverterTypeClientKeys.lower($0) }
...
extension AggregatedCoinInformation: Sendable {}
...
public struct ClientKeys {
    public let binance: String
    public let coinWatch: String
    public let alpha: String

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(binance: String, coinWatch: String, alpha: String) {
...
extension ClientKeys: Sendable {}
extension ClientKeys: Equatable, Hashable {
    public static func == (lhs: ClientKeys, rhs: ClientKeys) -> Bool {
        if lhs.binance != rhs.binance {
            return false
        }
        if lhs.coinWatch != rhs.coinWatch {
            return false
        }
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(coinWatch)
        hasher.combine(alpha)
    }
}

public struct FfiConverterTypeClientKeys: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ClientKeys {
        return
            try ClientKeys(
                binance: FfiConverterString.read(from: &buf),
                coinWatch: FfiConverterString.read(from: &buf),
                alpha: FfiConverterString.read(from: &buf)
            )
    }

    public static func write(_ value: ClientKeys, into buf: inout [UInt8]) {
        FfiConverterString.write(value.binance, into: &buf)
        FfiConverterString.write(value.coinWatch, into: &buf)
        FfiConverterString.write(value.alpha, into: &buf)
    }
}

public func FfiConverterTypeClientKeys_lift(_ buf: RustBuffer) throws -> ClientKeys {
    return try FfiConverterTypeClientKeys.lift(buf)
}

public func FfiConverterTypeClientKeys_lower(_ value: ClientKeys) -> RustBuffer {
    return FfiConverterTypeClientKeys.lower(value)
}
...
public struct FfiConverterTypeCoin: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Coin {
        return
            try Coin(
                ...
                rate: FfiConverterOptionDouble.read(from: &buf),
                volume: FfiConverterOptionInt64.read(from: &buf),
    ...
    public static func write(_ value: Coin, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionDouble.write(value.rate, into: &buf)
        FfiConverterOptionInt64.write(value.volume, into: &buf)
...
public struct CoinHistory {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(code: String?, name: String?, symbol: String?, rank: Int64?, color: String?, png64: String?, webp64: String?, allTimeHighUsd: Double?, links: Links?, history: [History]?) {
        self.code = code
        self.name = name
        self.symbol = symbol
        self.rank = rank
...
extension CoinHistory: Sendable {}
extension CoinHistory: Equatable, Hashable {
...
public struct FfiConverterTypeCoinHistory: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> CoinHistory {
        return
            try CoinHistory(
                code: FfiConverterOptionString.read(from: &buf),
                name: FfiConverterOptionString.read(from: &buf),
                symbol: FfiConverterOptionString.read(from: &buf),
                rank: FfiConverterOptionInt64.read(from: &buf),
                color: FfiConverterOptionString.read(from: &buf),
                png64: FfiConverterOptionString.read(from: &buf),
                webp64: FfiConverterOptionString.read(from: &buf),
                allTimeHighUsd: FfiConverterOptionDouble.read(from: &buf),
                links: FfiConverterOptionTypeLinks.read(from: &buf),
                history: FfiConverterOptionSequenceTypeHistory.read(from: &buf)
            )
    }

    public static func write(_ value: CoinHistory, into buf: inout [UInt8]) {
        FfiConverterOptionString.write(value.code, into: &buf)
        FfiConverterOptionString.write(value.name, into: &buf)
        FfiConverterOptionString.write(value.symbol, into: &buf)
        FfiConverterOptionInt64.write(value.rank, into: &buf)
        FfiConverterOptionString.write(value.color, into: &buf)
        FfiConverterOptionString.write(value.png64, into: &buf)
        FfiConverterOptionString.write(value.webp64, into: &buf)
        FfiConverterOptionDouble.write(value.allTimeHighUsd, into: &buf)
        FfiConverterOptionTypeLinks.write(value.links, into: &buf)
        FfiConverterOptionSequenceTypeHistory.write(value.history, into: &buf)
    }
}

public func FfiConverterTypeCoinHistory_lift(_ buf: RustBuffer) throws -> CoinHistory {
    return try FfiConverterTypeCoinHistory.lift(buf)
}

public func FfiConverterTypeCoinHistory_lower(_ value: CoinHistory) -> RustBuffer {
    return FfiConverterTypeCoinHistory.lower(value)
}
...
extension CoinHistoryRequest: Sendable {}
...
public struct CoinMeta {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(name: String?, symbol: String?, rank: Int64?, color: String?, png64: String?, webp64: String?, allTimeHighUsd: Double?, code: String?, rate: Double?, delta: Delta?) {
        self.name = name
        self.symbol = symbol
        self.rank = rank
        self.color = color
...
extension CoinMetaRequest: Sendable {}
...
public struct FfiConverterTypeDelta: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Delta {
        return
            try Delta(
                hour: FfiConverterOptionDouble.read(from: &buf),
                day: FfiConverterOptionDouble.read(from: &buf),
                week: FfiConverterOptionDouble.read(from: &buf),
                month: FfiConverterOptionDouble.read(from: &buf),
                quarter: FfiConverterOptionDouble.read(from: &buf),
                year: FfiConverterOptionDouble.read(from: &buf)
            )
    }

    public static func write(_ value: Delta, into buf: inout [UInt8]) {
        FfiConverterOptionDouble.write(value.hour, into: &buf)
        FfiConverterOptionDouble.write(value.day, into: &buf)
        FfiConverterOptionDouble.write(value.week, into: &buf)
        FfiConverterOptionDouble.write(value.month, into: &buf)
        FfiConverterOptionDouble.write(value.quarter, into: &buf)
        FfiConverterOptionDouble.write(value.year, into: &buf)
    }
}
...
extension FfiNetworkingRequest: Sendable {}
...
extension FfiNetworkingResponse: Sendable {}
...
public struct History {
    ...
    public let volume: Int64?
    public let cap: Int64?
    public let liquidity: Int64?

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(date: Int64?, rate: Double?, volume: Int64?, cap: Int64?, liquidity: Int64?) {
        self.date = date
        self.rate = rate
        self.volume = volume
        self.cap = cap
...
extension History: Equatable, Hashable {
    public static func == (lhs: History, rhs: History) -> Bool {
        ...
        if lhs.liquidity != rhs.liquidity {
            return false
        }
        return true
    }
...
public struct FfiConverterTypeHistory: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> History {
        return
            try History(
                ...
                volume: FfiConverterOptionInt64.read(from: &buf),
                cap: FfiConverterOptionInt64.read(from: &buf),
                liquidity: FfiConverterOptionInt64.read(from: &buf)
            )
    }
    ...
    public static func write(_ value: History, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionInt64.write(value.volume, into: &buf)
        FfiConverterOptionInt64.write(value.cap, into: &buf)
        FfiConverterOptionInt64.write(value.liquidity, into: &buf)
    }
}
...
public struct ListOfCoinsRequest {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(currency: String, sort: String, order: String, offset: UInt8, limit: UInt32, meta: Bool) {
        self.currency = currency
        self.sort = sort
        self.order = order
        self.offset = offset
...
extension ListOfCoinsRequest: Sendable {}
...
extension MostActivelyTraded: Sendable {}
...
extension RecentTradesResponse: Sendable {}
...
extension TopAndBottomTrades: Sendable {}
...
extension FfiSideError: Sendable {}
...
extension RustSideError: Sendable {}
...
private struct FfiConverterOptionTypeLinks: FfiConverterRustBuffer {
    typealias SwiftType = Links?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeLinks.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeLinks.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
private struct FfiConverterSequenceTypeCoinMeta: FfiConverterRustBuffer {
    typealias SwiftType = [CoinMeta]

    public static func write(_ value: [CoinMeta], into buf: inout [UInt8]) {
        let len = Int32(value.count)
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeCoinMeta.write(item, into: &buf)
        }
    }
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [CoinMeta] {
        ...
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            try seq.append(FfiConverterTypeCoinMeta.read(from: &buf))
        }
        return seq
    }
}
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_crypto_service_checksum_method_gateway_get_coin_history_info() != 17599 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_crypto_service_checksum_method_gateway_get_coin_meta_info() != 28064 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_crypto_service_checksum_method_gateway_get_list_of_coins() != 27253 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_crypto_service_checksum_method_networkantenna_make_request() != 5199 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_crypto_service_checksum_method_networkantenna_get_api_keys() != 36893 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_crypto_service_checksum_constructor_gateway_new() != 36044 {
        return InitializationResult.apiChecksumMismatch
    }
