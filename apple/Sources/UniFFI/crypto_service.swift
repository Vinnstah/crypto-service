...
public protocol GatewayProtocol: AnyObject {
    func getListOfAggCoins(key: String) async throws -> [AggregatedCoinInformation]
}
    ...
    GatewayProtocol
{
    ...
    open func getListOfAggCoins(key: String) async throws -> [AggregatedCoinInformation] {
        return
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_crypto_service_checksum_method_gateway_get_list_of_agg_coins() != 63919 {
